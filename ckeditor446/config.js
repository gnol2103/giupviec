...
(function() {
    ...
    CKEDITOR.editorConfig = function(config) {
        ...
        ***/
        ...
        // File browser
        config.filebrowserBrowseUrl = "/ckeditor446/ckfinder/ckfinder.php",
            config.filebrowserUploadUrl = "/ckeditor446/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files",
            config.filebrowserImageUploadUrl = "/ckeditor446/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images",
            config.filebrowserFlashUploadUrl = "/ckeditor446/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash",
